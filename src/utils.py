...
def log_msg():
    ...
    print(f"[RAG-CONFIG] xinference llm model id: {getenv('XINFERENCE_LLM_MODEL_ID')}".ljust(max_length))
    print(f"[RAG-CONFIG] xinference embedding model id: {getenv('XINFERENCE_EMBEDDING_MODEL_ID')}".ljust(max_length))
